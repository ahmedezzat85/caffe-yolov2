...
if NOT DEFINED APPVEYOR (
    ...
    REM :: Create an environment
    REM :: Todo create protobuf package for vc14
    REM conda install --yes cmake ninja numpy scipy protobuf==3.1.0 six scikit-image pyyaml
...
REM if EXIST build (
    REM echo ERROR: build directory already exists in %cd%\build please remove it and start over.
    REM exit /b 1
REM )
